...
function tableLoader(){
    ...
    $.ajax({
        ...
        for (var i = 0; i < data.length; i++) {
                ...
                "<th>"+data[i].autor+"</th>");
                var innertable2;
                if((getname())==(data[i].autor)){
                    innertable+=("<th>"+"<button  type=\"button\"  id=\"Edit\" value=\""+data[i].id+"\">Edit</button>\n"+"</th>"+
                        "<th>"+"<button type=\"button\"  id=\"Delete\" value=\""+data[i].id+"\">Delete</button>\n"+"</th>"+
                        +"</tr>")
                }else{
                     innertable+=("<th>Edit</th>"+"<th>Delete</th>");
                }
            $('#apnd').append(innertable).append(innertable2);
